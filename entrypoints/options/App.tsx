...
function App() {
  ...
  if (isLoading) {
    return (
      <main className="grid min-h-screen place-items-center bg-[#f3f6f3] text-[#172033] dark:bg-[#101827] dark:text-[#edf4f2]">
        <Loader2 className="h-6 w-6 animate-spin text-[#6a9d9a]" />
      </main>
    );
  }

  return (
    <main className="min-h-screen bg-[#f3f6f3] px-6 py-8 text-[#172033] dark:bg-[#101827] dark:text-[#edf4f2]">
      <div className="mx-auto flex max-w-5xl flex-col gap-6">
        <header className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-sm font-semibold text-[#2f6f73] dark:text-[#9fd5ce]">
              WebProse Context
            </p>
        ...
        >
          <section className="rounded-lg border border-[#d9e4e2] bg-[#fbfaf7] p-5 shadow-sm dark:border-[#304258] dark:bg-[#121d2e]">
            <div className="flex items-start gap-3">
              <ServerCog className="mt-1 h-5 w-5 text-[#2f6f73] dark:text-[#9fd5ce]" />
              <div>
                <h2 className="text-lg font-semibold">Connection</h2>
                <p className="mt-1 text-sm leading-6 text-[#4f5f72] dark:text-[#b8c8c7]">
          ...
          <aside className="rounded-lg border border-[#d9e4e2] bg-[#fbfaf7] p-5 shadow-sm dark:border-[#304258] dark:bg-[#121d2e]">
